...
function(a) {
    ...
    a.Sector3D = a.extend(a.Sector, {
        configure: function() {
            a.Sector3D.superclass.configure.apply(this, arguments),
            this.type = "sector3d",
            this.dimension = a._3D,
            this.set({
                semi_major_axis: 0,
        ...
        doConfig: function() {
            ...
            d = b.get("middleAngle");
            b.a = b.get("semi_major_axis"),
            b.b = b.get("semi_minor_axis"),
            b.h = b.get("cylinder_height"),
            a.Assert.isTrue(b.a * b.b >= 0, "major&minor");
            var e = 2 * Math.PI,
            f = function(d) {
                for (; 0 > d;) d += e;
    ...
    a.Pie = a.extend(a.Chart, {
        configure: function() {
            a.Pie.superclass.configure.call(this),
            this.type = "pie",
            this.set({
                radius: "100%",
                offset_angle: 0,
        ...
        doAnimation: function(a, b, c) {
            ...
            c.sectors.each(function(f) {
                d = c.animationArithmetic(a, 0, f.get("totalAngle"), b),
                f.push("startAngle", e),
                f.push("endAngle", e += d),
                c.is3D() || f.drawSector()
            }),
        ...
        doParse: function(a, b, c) {
            ...
            a.doActing(a, b, null, c, d),
            a.push("sub_option.id", c),
            a.get("sub_option.label") && a.push("sub_option.label.text", d),
            a.push("sub_option.listeners.changed",
            function(b, c) {
        ...
        dolayout: function(b, c, d, e, f, g) { (b.is3D() ? a.inEllipse(b.get(b.X) - c, b.topY - d, b.a, b.b) : a.distanceP2P(b.get(b.X), b.topY, c, d) < b.r) && (d = b.topY - d, e.push("labelx", b.get(b.X) + (2 * Math.sqrt(b.r * b.r - d * d) + f) * (0 == g || 3 == g ? 1 : -1)), e.localizer(e))
        },
        localizer: function(a) {
            if (a.get("intellectLayout")) {
                ...
                e.each(function(e) {
                    f.each(function(f) {
                        c = f.labelx,
                        d = f.labely,
                        (e.labely <= d && d - e.labely - 1 < e.get(a.H) || e.labely > d && e.labely - d - 1 < f.get(a.H)) && (e.labelx <= c && c - e.labelx < e.get(a.W) || e.labelx > c && e.labelx - c < f.get(a.W)) && (b = e.get("quadrantd"), e.push("labely", e.get("labely") + d - e.labely + (e.get(a.H) + g) * (b > 1 ? -1 : 1)), e.localizer(e), a.dolayout(a, e.get("labelx"), e.get("labely") + e.get(a.H) / 2 * (2 > b ? -1 : 1), e, g, b))
                    },
                    a),
                    f.push(e)
                })
        ...
        doConfig: function() {
            ...
            f = 2 * Math.PI;
            c.sub = c.is3D() ? "Sector3D": "Sector2D",
            c.sectors.zIndex = c.get("z_index"),
            c.sectors.length = 0,
            c.oA = a.angle2Radian(c.get("offset_angle")) % f,
            c.is3D() && (e += .06);
            var g = c.data.length,
            ...
            k = j;
            0 == c.total && (b = 1 / g),
            c.data.each(function(a, d) {
                j += (b || a.value / c.total) * i,
                d == g - 1 && (j = f + c.oA),
                a.startAngle = k,
                a.endAngle = j,
                a.totalAngle = j - k,
            ...
            c),
            c.r = d = a.parsePercent(d, Math.floor(c.get("minDistance") * e)),
            c.topY = c.originXY(c, [d + c.get("l_originx"), c.get("r_originx") - d, c.get("centerx")], [c.get("centery")]).y,
            a.apply(c.get("sub_option"), a.clone([c.X, c.Y, "bound_event", "mutex", "increment"], c.options))
        }
    }),
    a.Pie2D = a.extend(a.Pie, {
        configure: function() {
            a.Pie2D.superclass.configure.call(this),
            this.type = "pie2d"
        },
        doConfig: function() {
            a.Pie2D.superclass.doConfig.call(this);
            var b = this._();
            b.push("sub_option.radius", b.r),
            b.parse(b)
        }
    }),
    a.register("Pie2D"),
    a.Pie3D = a.extend(a.Pie, {
        configure: function() {
            a.Pie3D.superclass.configure.apply(this, arguments),
            this.type = "pie3d",
            this.dimension = a._3D,
            this.set({
                zRotate: 45,
        ...
        doSector: function(b, c) {
            return b.push("sub_option.cylinder_height", c.cylinder_height ? c.cylinder_height * b.get("zRotate_") : b.get("cylinder_height")),
            new a[b.sub](b.get("sub_option"), b)
        },
        one: function(b) {
            var c, d, e, f = [],
            ...
            b.proxy.drawSector = function() {
                ...
                c = [],
                d = [],
                b.sectors.each(function(b) {
                    lay(g, b.get(i), b.get(j), b),
                    lay(!g, b.get(j), b.get(i), b),
                    d = d.concat(a.visible(b.get(i), b.get(j), b))
                },
                b),
                c.sor(function(a, b) {
                    var c = h(a.g) - h(b.g);
                ...
                b),
                b.processAnimation || d.sor(function(a, b) {
        ...
        doConfig: function() {
            ...
            b.push("cylinder_height", b.get("yHeight") * b.push("zRotate_", Math.abs(Math.cos(c)))),
            b.a = b.push("sub_option.semi_major_axis", b.r),
            b.b = b.push("sub_option.semi_minor_axis", b.r * Math.abs(Math.sin(c))),
            b.topY = b.push("sub_option.originy", b.get(b.Y) - b.get("yHeight") / 2),
            b.parse(b),
            b.one(b)
        }
    }),
    a.register("Pie3D"),
    a.Donut2D = a.extend(a.Pie, {
        configure: function() {
            a.Donut2D.superclass.configure.call(this),
            this.type = "donut2d",
            this.set({
                donutwidth: .3,
                center: {
        ...
        doConfig: function() {
            ...
            d = b.get(c),
            e = b.r;
            b.push("sub_option.radius", e),
            d >= e ? d = 0 : 1 > d && (d = Math.floor(e * d)),
            b.push("sub_option.donutwidth", b.push(c, d)),
            b.merge("center"),
            "" != b.get("center.text") && (b.push("center.originx", b.get(b.X)), b.push("center.originy", b.get(b.Y)), b.push("center.textBaseline", "middle"), b.center = new a.Text(b.get("center"), b), b.oneways.push(b.center)),
            b.parse(b)
        }
    }),
    a.register("Donut2D"),
    ...
    a.ColumnMulti3D = a.extend(a.ColumnMulti2D, {
        configure: function() {
            a.ColumnMulti3D.superclass.configure.call(this),
    ...
    a.ColumnStacked3D = a.extend(a.ColumnStacked2D, {
        configure: function() {
            a.ColumnStacked3D.superclass.configure.call(this),

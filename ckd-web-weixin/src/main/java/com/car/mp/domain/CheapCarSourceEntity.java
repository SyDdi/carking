 ...
 *
 */
public class CheapCarSourceEntity implements Serializable {
	private int id;
	// 牌照日期
	...
	public Date getFindDay() {
		return findDay;
	}

	public void setFindDay(Date findDay) {
		this.findDay = findDay;
	}

	@Override
	public String toString() {
		return "CheapCarSourceEntity [id=" + id + ", licenseDay=" + licenseDay + ", licenseArea=" + licenseArea

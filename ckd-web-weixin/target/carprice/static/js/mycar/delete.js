...
qikoo.dialog = function() {
    var e, t, n = {}, r = function() {
            var n = ['<div class="mod-dialog-bg"></div>', '<div class="mod-dialog" style="z-index:9999999;">', '<div class="dialog-nav" style="display:none;">', '<span class="dialog-title"></span>', '<a href="#" onclick="return false" class="dialog-close"></a>', "</div>", '<div class="dialog-main"></div>', "</div>"].join(""),
    ...
    var r = ['<div class="dialog-content">', "<p>" + e + "</p>", "</div>", '<div class="dialog-console clearfix_new">', '<a class="console-btn-cancel" onclick="return false;">取消</a>','<a class="console-btn-confirm" onclick="del();">确定</a>', "</div>"].join(""),
        i = qikoo.dialog.show({
            html: r
        });
